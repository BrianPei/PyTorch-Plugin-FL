...
| Kunlun P800 | `ACCELERATOR=kunlun` | CUDA boxing over the XPU CUDA-compatibility runtime and vendor CUDA registrations | Experimental (runtime, copies, streams/events, and `mm` smoke measured) | Not validated | Not validated | Not validated | Not revalidated (build disables FlagGems) | Experimental |
